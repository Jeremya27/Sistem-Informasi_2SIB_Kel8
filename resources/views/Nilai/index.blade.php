        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('nilaisiswa.create') }}" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('nilaisiswa.destroy', $Nilai->id_nilai) }}" method="post">
                                            <a href="{{ route('nilaisiswa.edit', $Nilai->id_nilai) }}" class="btn btn-sm btn-primary">EDIT</a>
