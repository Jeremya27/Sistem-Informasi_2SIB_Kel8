                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Kelas Siwa</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($data as $data_siswa)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('siswa.destroy', $data_siswa->id) }}" method="post">
                                            <a href="{{ route('siswa.edit', $data_siswa->id) }}" class="btn btn-sm btn-primary">EDIT</a>
