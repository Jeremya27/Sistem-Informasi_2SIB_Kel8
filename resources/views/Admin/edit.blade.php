...
initial-scale=1.0">
    ...
    <title>Tambah Data Admin - Admin</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('admin1.update',

$data->id_admin) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar" class="form-control @error('email') is-invalid @enderror"
...
mt-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar" class="form-control @error('username') is-invalid @enderror"
...
@error('prodi') is-invalid @enderror" name="password" placeholder="Password" value="{{ $data->password }}">
